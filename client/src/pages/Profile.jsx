  ...
  return (
    <div className="p-3 max-w-lg mx-auto" >
      ...
      <img onClick={() => fileRef.current.click()} src={formData.avatar || currentUser.avatar} alt="profile"
       className="rounded-full h-25 w-28 object-cover cursor-pointer self-center mt-2 />" />
      ...
      <p className="text-sm self-center">
       ...
       : filePerc === 100 ? (
        <span className="text-green-700">Profile image upload successfully</span>
       ): ( '')
      } 
      </p>
      ...
      <Link className="bg-green-600 text-white p-3 rounded-lg uppercase text-center 
      ...
      className="text-green-600 w-full uppercase" >Show Listings</button>
      ...
      <Link className="text-slate-600 font-semibold flex-1 hover:underline truncate" to={`/listing/${listing._id}`}>
      <p >{listing.name}</p>
      </Link>
